...
export const exercises: MMExercise[] = [
  ...
  },
  {
    ...
    type: 'timedRecall',
    items: ['Hammer', 'Butterfly', 'Mountain', 'Guitar', 'Moon', 'Dragon', 'Waterfall', 'Crown', 'Lighthouse', 'Compass', 'Eagle', 'Crystal', 'Thunder', 'Violin', 'Castle'],
    studySeconds: 90,
    prompt: 'Create a far-fetched association chain to memorize 15 items in 90 seconds.',
    instructions: 'Link each item to the next with an absurd, vivid, action-filled mental image. You have 90 seconds to study all 15 items, then recall them in order.',
  },
  {
    id: 13, day: 13, title: 'The 20-Item Supermemory Challenge',
    type: 'timedRecall',
    items: ['Elephant', 'Candle', 'Submarine', 'Strawberry', 'Pyramid', 'Telescope', 'Whale', 'Lantern', 'Cactus', 'Parachute', 'Hourglass', 'Volcano', 'Butterfly', 'Anchor', 'Meteor', 'Windmill', 'Scorpion', 'Crystal Ball', 'Labyrinth', 'Phoenix'],
    studySeconds: 120,
    prompt: 'Your supermemory challenge — 20 items! Push your association technique to its limits.',
    instructions: 'Create vivid, far-fetched associations linking each item to the next. You have 2 minutes to memorize all 20 in order.',
  },
  {
